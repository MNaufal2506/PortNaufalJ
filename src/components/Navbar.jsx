...
export default function Navbar() {
  return (
    <nav className="bg-black text-white px-8 lg:px-20  py-3 lg:py-5 flex justify-between fixed top-0 left-0 w-full border-b-2 rounded-b-2xl z-50">
     ...
     <ul className="hidden lg:flex gap-6 items-center justify-center ">
        ...
        <li className="w-8 h-8 hover:scale-125 transition-transform duration-300 flex items-center"><a href=""><img src={dis} alt="" /></a></li>
        <li className="w-8 h-8 hover:scale-125 transition-transform duration-300 flex items-center"><a href=""><img src={what} alt="" /></a></li>
     </ul>
    </nav>
  );
}
